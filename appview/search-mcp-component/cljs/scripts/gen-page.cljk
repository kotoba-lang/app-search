...
(defn page []
  (dds-page/->page
   {:title "search-mcp-component"
    :description "Search — AI Agent for search intelligence and analytics (reagent + re-frame + jp-go-dds)."
    :lang "ja"
    :css dds-css}
   [:div {:id "app"} "search-mcp-component loading…"]
